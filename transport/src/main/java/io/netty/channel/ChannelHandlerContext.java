 ...
 *
 * 允许{@link ChannelHandler}与它的{@link ChannelPipeline}和其他处理器交互。
 * 除了其他事情，一个处理器可以通知{@link ChannelPipeline}中的下一个{@link ChannelHandler}，
 * 也可以动态地修改它所属的{@link ChannelPipeline}。
 * 
 * <h3>Notify</h3>
 *
